    ...
    for cond in tqdm.tqdm(conditions):
        ...
        for meet in meeting:
            ...
            for mic in args.mics:
                ...
                new_wav_path = "sox {} -t wav - remix {} |".format(
                    wav_path, mic + 1
                )  # channel will be extracted on the fly
            ...
            with open(
                ...
                next(f)
                for line in f:
                    start, end, spkid, clean_uttid, text = line.strip().split(
                        maxsplit=4
                    )
                    ...
                    if args.cleanpath:
                        utt2clean[utt_id] = "sox {} -t wav - |".format(
                            clean_paths[clean_uttid]
                        )
