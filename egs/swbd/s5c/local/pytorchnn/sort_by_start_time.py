...
def main():
    parser = argparse.ArgumentParser(
        description="Sort utterances per "
        "conversation of SWBD dataset by the "
        "starting time of each utterance."
    )
    parser.add_argument("--infile", type=str, required=True, help="File to be sorted.")
    parser.add_argument(
        "--outfile", type=str, required=True, help="Sorted output file."
    )
