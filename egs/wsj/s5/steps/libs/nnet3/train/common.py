...
def verify_egs_dir(egs_dir, feat_dim, ivector_dim, ivector_extractor_id,
    ...
    try:
        ...
        if (((egs_ivector_id is None) and (ivector_extractor_id is not None)) or
            ...
            logger.warning("ivector for egs: {0} in dir {1}".format(egs_ivector_id, egs_dir))
            logger.warning("ivector for extractor: {0}".format(ivector_extractor_id))
        elif ((egs_ivector_dim > 0) and
              ((egs_ivector_id is None) and (ivector_extractor_id is None))):
