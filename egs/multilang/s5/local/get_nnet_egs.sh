...
if [ ! -z $metadata_feats ]; then
    ...
    feats="$feats append-vector-to-feats ark:- ark,t:$metadata_feats ark:- |"
    valid_feats="$valid_feats append-vector-to-feats ark:- ark,t:$metadata_feats ark:- |"
    train_subset_feats="$train_subset_feats append-vector-to-feats ark:- ark,t:$metadata_feats ark:- |"
